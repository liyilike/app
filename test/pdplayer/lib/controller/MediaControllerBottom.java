 ...
 */
public class MediaControllerBottom extends RelativeLayout{
    public  ImageView bottomPlay,bottomFull;
    public TextView bottomZHIBO;
    public MediaControllerBottom(@NonNull Context context) {
        super(context);
        init();
    }

    public MediaControllerBottom(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MediaControllerBottom(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        View rootView = inflate(getContext(), R.layout.controller_bottom, this);
